...
function fn_show_order_detail(){
	...
	if(payType == '카카오페이(간편결제)'){
		...
		var orderNumber = 'order20221014'
		var amount = $('#h_each_goods_price').val()
		var itemName = $('#h_goods_title').val()
		var userName = $('#h_orderer_name').val()
		console.log("=========================")
...
// 			async : false, //false인 경우 동기식으로 처리한다.
			...
			success : function(data, textStatus) {
				...
				if(data.responseCode == '0000'){//주문 성공시 
					//주문 요청 후 응답 데이터를 form에 넣음
...
// 	alert("최종 결제하기");
    ...
    //form에 카드정보 넣기
    formObj.appendChild(document.getElementById("cardNo"));
    formObj.appendChild(document.getElementById("expireMonth"));
    formObj.appendChild(document.getElementById("expireYear"));
    formObj.appendChild(document.getElementById("birthday"));
    formObj.appendChild(document.getElementById("cardPw"));
		...
		<div id="layer" style="visibility: hidden">
			...
			<div id="popup_order_detail">
					...
					<table>
						<tbody align=left>
							...
							<tr>
								...
								<td align=left><input id="cardNo" name="cardNo" type="text"
									size="20" maxlength="20" value="" /></td>
							</tr>
							<tr>
								<td width=200px>유효기간 월 :</td>
								<td align=left><input id="expireMonth" name="expireMonth"
									type="text" size="2" maxlength="2" value="" /></td>
							</tr>
							<tr>
								<td width=200px>유효기간 년 :</td>
								<td align=left><input id="expireYear" name="expireYear"
									type="text" size="2" maxlength="2" value="" /></td>
							</tr>
							<tr>
								<td width=200px>생년월일 :</td>
								<td align=left><input id="birthday" name="birthday"
									type="text" size="8" maxlength="8" value="" /></td>
							</tr>
							<tr>
								<td width=200px>비밀번호2자리 :</td>
								<td align=left><input id="cardPw" name="cardPw" type="text"
									size="2" maxlength="2" value="" /></td>
							</tr>
							<tr>
				...
				<form name="order_info" method="post" accept-charset="euc-kr">
					<input type="hidden" name="ordr_idxx" value=""> <input
						type="hidden" name="good_name" value=""> <input
						type="hidden" name="good_mny" value=""> <input
						type="hidden" name="buyr_name" value=""> <input
						...
						name="param_opt_2" value=""> <input type="hidden"
						name="param_opt_3" value=""> <input type="hidden"
						name="res_cd" value="" /> <input type="hidden" name="res_msg"
						value="" /> <input type="hidden" name="enc_info" value="" /> <input
						type="hidden" name="enc_data" value="" /> <input type="hidden"
						name="ret_pay_method" value="" /> <input type="hidden"
